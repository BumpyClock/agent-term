//! Context menu component for agentterm-gpui.
//!
//! Provides right-click context menu support using PopupMenu.
//! Simplified from gpui-component with theme system removed.
...
use gpui::{
    ...
    Pixels, Point, StyleRefinement, Styled, Subscription, Window,
};
                                        ...
                                        .child(
                                            anchored()
                                                ...
                                                .when_some(menu_view, |this, menu| {
                                                    // Focus the menu so that it can handle actions.
                                                    if !menu
                                                        .focus_handle(cx)
    ...
    fn paint(
        ...
        self.with_element_state(
            ...
            |_view, state: &mut ContextMenuState, window, _| {
                ...
                // When right mouse click, build context menu and show it at the mouse position.
