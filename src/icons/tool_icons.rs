...
pub const TOOL_ICONS: &[ToolIconInfo] = &[
    ...
    ToolIconInfo {
        id: "claude-logo",
        label: "Claude Logo",
        filename: "claude-logo.svg",
        monochrome: false,
    },
    ToolIconInfo {
        id: "anthropic",
        label: "Anthropic",
        filename: "anthropic-logo.svg",
        monochrome: true,
    },
    ToolIconInfo {
        id: "openai",
    ...
    ToolIconInfo {
        id: "vscode",
        label: "VS Code",
        filename: "Visual_Studio_Code_1.35_icon.svg",
        monochrome: false,
    },
    ToolIconInfo {
        id: "python",
    ...
    ToolIconInfo {
        id: "windsurf",
        label: "Windsurf",
        filename: "windsurf-white-symbol.svg",
        monochrome: true,
    },
    ToolIconInfo {
        id: "ubuntu",
